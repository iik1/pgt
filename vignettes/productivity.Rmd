...
The intervals are heuristic: resampling theory for data envelopment
analysis covers the radial and directional technologies, not the
materials-balance programs here, so their coverage is not backed by a
convergence-rate result. Because efficiency scores are biased toward the
frontier, the resampling distribution is not centred on the point
estimate. Before relying on the intervals, check that their width is
stable in the subsample size.

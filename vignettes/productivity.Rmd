...
faithful comparator. The `"wgd"` and `"envelope"` options treat the
bad output as reducible to the peer emission envelope and are
exploratory companions (the `"wgd"` label here keeps the input rows,
matching the input-fixed benchmark of `pgt()` rather than its Eq. 6
programme).

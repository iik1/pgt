...
Two components are 1 by construction on this panel: the coefficients
are homogeneous, so quality is 1, and with the account closed and every
input held, the first stage pins emissions at the observed level, so
production technical efficiency is 1. Production allocative
efficiency, the stage that frees the material inputs, carries most of
the gap. The abatement components separate the plants by what they
